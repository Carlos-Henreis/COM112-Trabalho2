...
${OBJECTDIR}/_ext/1928587098/Btree.o: ../../../Área\ de\ Trabalho/\[COM-112\]\ Trabalho\ Prático\ 2/Arquivos\ de\ Código-Fonte/Btree.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1928587098/Btree.o ../../../Área\ de\ Trabalho/\[COM-112\]\ Trabalho\ Prático\ 2/Arquivos\ de\ Código-Fonte/Btree.c

${OBJECTDIR}/_ext/1928587098/Conversion.o: ../../../Área\ de\ Trabalho/\[COM-112\]\ Trabalho\ Prático\ 2/Arquivos\ de\ Código-Fonte/Conversion.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1928587098
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1928587098/Conversion.o ../../../Área\ de\ Trabalho/\[COM-112\]\ Trabalho\ Prático\ 2/Arquivos\ de\ Código-Fonte/Conversion.c

${OBJECTDIR}/_ext/1928587098/RBtree.o: ../../../Área\ de\ Trabalho/\[COM-112\]\ Trabalho\ Prático\ 2/Arquivos\ de\ Código-Fonte/RBtree.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1928587098
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1928587098/RBtree.o ../../../Área\ de\ Trabalho/\[COM-112\]\ Trabalho\ Prático\ 2/Arquivos\ de\ Código-Fonte/RBtree.c

${OBJECTDIR}/_ext/1928587098/VP.o: ../../../Área\ de\ Trabalho/\[COM-112\]\ Trabalho\ Prático\ 2/Arquivos\ de\ Código-Fonte/VP.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1928587098
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1928587098/VP.o ../../../Área\ de\ Trabalho/\[COM-112\]\ Trabalho\ Prático\ 2/Arquivos\ de\ Código-Fonte/VP.c

${OBJECTDIR}/_ext/1928587098/main.o: ../../../Área\ de\ Trabalho/\[COM-112\]\ Trabalho\ Prático\ 2/Arquivos\ de\ Código-Fonte/main.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1928587098
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1928587098/main.o ../../../Área\ de\ Trabalho/\[COM-112\]\ Trabalho\ Prático\ 2/Arquivos\ de\ Código-Fonte/main.c

${OBJECTDIR}/_ext/1928587098/menu.o: ../../../Área\ de\ Trabalho/\[COM-112\]\ Trabalho\ Prático\ 2/Arquivos\ de\ Código-Fonte/menu.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1928587098
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1928587098/menu.o ../../../Área\ de\ Trabalho/\[COM-112\]\ Trabalho\ Prático\ 2/Arquivos\ de\ Código-Fonte/menu.c
